...
cv2.createTrackbar("SAT Min", "HSV",107,2555,empty)
  ...
  for cnt in contours:
    ...
    if area > areaMin:
      ...
      if (cx<int(frameWidth/2)-deadZone):
        ...
        cv2.putText(imgContour, " GO RIGHT ", (20,50), cv2.FONT_HERSHEY_COMMPLEX, 1,(0,0,255), 3)
        ...
        cv2.rectangle(imgContour,(imgContour,(int(frameWidth/2-deadZone),int(frameHeight/2)+deadZone),frameHeight),(0,0,255),cv2.FILLED)
        dir = 4
      else: dir=0

      cv2.line(imgContour,(int(frameWidth/2),int(frameHeight/2)), (cx,cy),(0,0,255), 3)
      cv2.rectangle(imgContour, (x , y ), (x + w , y + h ), (0, 255, 0), 5)
      cv2.putText(imgContour, "Points: " + str(len(approx)), (x + 2 + 20, y +20), cv2.FONT_HERSHEY_COMPLEX, 0.7, (0,255,0),2)
...
def display(img):
  ...
  cv2.line(img,(int(frameWidth/2)+deadZone,0), (frameWidth,int(frameHeight / 2) + deadZone, (255,255,0), 3))

  cv2.circle(img,(int(frameWidth/2),int(frameHeight/2)),5,(0,0,255),5)
  cv2.line(img,(0,int(frameHeight / 2) - deadZone), (frameWidth, int(frameHeight / 2) - deadZone), (255,255,0), 3)
  cv2.line(img,(0,img(frameHeight / 2) + deadZone), (frameWidth, int(frameHeight / 2) + deadZone), (255,255,0), 3)
...
while True:
  ...
  h_min = cv2.getTrackbasPos("HUE Min" , "HSV")
  ...
  threshold1 = cv2.getTackbarPos("threshold1","Parameters")
